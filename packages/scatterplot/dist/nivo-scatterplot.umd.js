(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/voronoi'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('recompose/setDisplayName'), require('@nivo/colors'), require('@nivo/scales'), require('prop-types'), require('@nivo/tooltip')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', '@nivo/core', '@nivo/axes', '@nivo/legends', '@nivo/voronoi', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', 'recompose/setDisplayName', '@nivo/colors', '@nivo/scales', 'prop-types', '@nivo/tooltip'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global.nivo, global.nivo, global.nivo, global.nivo, global.RecomposeCompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposePure, global.RecomposeSetDisplayName, global.nivo, global.nivo, global.PropTypes, global.nivo));
}(this, function (exports, React, reactMotion, core, axes, legends, voronoi, compose, defaultProps, withPropsOnChange, pure, setDisplayName, colors, scales, PropTypes, tooltip) { 'use strict';
